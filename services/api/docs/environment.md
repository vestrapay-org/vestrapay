...
This document provides a comprehensive guide to configuring the VestraPay API using environment variables. The project uses a `.env` file to store all configuration settings including database connections, authentication, AWS services, and other application settings.
...
AUTH_TWO_FACTOR_ISSUER=VestraPayTwoFactor
...
# DATABASE_URL=mongodb+srv://username:password@cluster.mongodb.net/VestraPay
```
