...
This documentation explains the database architecture and features in VestraPay API:
...
In VestraPay API, you can use the `pnpm db:migrate` script to quickly sync your schema to MongoDB.
...
Seeding in VestraPay API is handled using [Commander.js][ref-commander]. All seed commands are implemented in `src/migration/seeds/*`.

### Database Seeds

VestraPay API provides ready-to-use seed scripts to help you quickly initialize or remove data for development and testing. Database seeding is used to populate the database with initial or test data, making development and testing easier.
...
VestraPay API uses **[Prisma][ref-prisma] v6.19.x** as the primary database toolkit. Prisma is not just an ORM - it's a complete database toolkit that provides the foundation for implementing clean architecture patterns.
...
```bash
# From:
DATABASE_URL=mongodb://localhost:27017/VestraPay?replicaSet=rs0

# To:
DATABASE_URL=postgresql://user:password@localhost:5432/VestraPay
```
...
[ack-contributors-shield]: https://img.shields.io/github/contributors/vestrapay-org/vestrapay?style=for-the-badge
[ack-forks-shield]: https://img.shields.io/github/forks/vestrapay-org/vestrapay?style=for-the-badge
[ack-stars-shield]: https://img.shields.io/github/stars/vestrapay-org/vestrapay?style=for-the-badge
[ack-issues-shield]: https://img.shields.io/github/issues/vestrapay-org/vestrapay?style=for-the-badge
[ack-license-shield]: https://img.shields.io/github/license/vestrapay-org/vestrapay?style=for-the-badge
...
[ref-author-linkedin]: https://linkedin.com/in/vestrapay-org
[ref-author-email]: mailto:dev@vestrapay.io
[ref-author-github]: https://github.com/vestrapay-org
[ref-author-paypal]: https://www.paypal.me/vestrapay-org
[ref-author-kofi]: https://ko-fi.com/vestrapay-org

<!-- Repo LINKS -->

[ref-ack]: https://github.com/vestrapay-org/vestrapay
[ref-ack-issues]: https://github.com/vestrapay-org/vestrapay/issues
[ref-ack-stars]: https://github.com/vestrapay-org/vestrapay/stargazers
[ref-ack-forks]: https://github.com/vestrapay-org/vestrapay/network/members
[ref-ack-contributors]: https://github.com/vestrapay-org/vestrapay/graphs/contributors
