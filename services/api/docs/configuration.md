...
This document provides a detailed explanation of how configuration works in the VestraPay API project, including the configuration files structure and their interfaces.
