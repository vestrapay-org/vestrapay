...
This document provides step-by-step instructions for setting up the VestraPay API on your development environment.
...
> **Note**: VestraPay API uses PNPM for package management. All documentation examples will use PNPM commands.
...
git clone https://github.com/vestrapay-org/vestrapay.git
...
VestraPay API uses **ES256** algorithm for Access Tokens and **ES512** for Refresh Tokens. You need to generate cryptographic key pairs for JWT authentication.
...
Docker provides the fastest and most reliable way to set up the VestraPay API. This method automatically configures the entire development environment with all dependencies and services pre-configured.
...
DATABASE_URL=mongodb://localhost:27017/VestraPay?retryWrites=true&w=majority&replicaSet=rs0
```
